class CreateJacaeiConfigs < ActiveRecord::Migration[7.0]
  def change
# unless table_exists?(:jacaei_configs)
    #   create_table :jacaei_configs do |t|
    #     t.boolean :active, default: true
    #     t.boolean :capture, default: false
    #     t.string :base_url, null: false, default: "ad2,ddds,,"
    ...
    # unless column_exists?(:clients, :has_jacaei)
    #   add_column :clients, :has_jacaei, :boolean, default: false
    # end


    # unless Gateway.exists?(name: 'jacaei')
    #   Gateway.create(
    #     version: '1',
    #     current: true,
    #     name: 'jacaei',
