class CreateVegapayConfigs < ActiveRecord::Migration[7.0]
  def change
# unless table_exists?(:vegapay_configs)
    #   create_table :vegapay_configs do |t|
    #     t.boolean :active, default: true
    #     t.boolean :capture, default: false
    #     t.string :base_url, null: false, default: "https://api.maxpagamentos.com.br/"
    ...
    # unless column_exists?(:clients, :has_vegapay)
    #   add_column :clients, :has_vegapay, :boolean, default: false
    # end


    # unless Gateway.exists?(name: 'vegapay')
    #   Gateway.create(
    #     version: '1',
    #     current: true,
    #     name: 'vegapay',
