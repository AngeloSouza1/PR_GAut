class CreatePerplexidConfigs < ActiveRecord::Migration[7.0]
  def change
# unless table_exists?(:perplexid_configs)
    #   create_table :perplexid_configs do |t|
    #     t.boolean :active, default: true
    #     t.boolean :capture, default: false
    #     t.string :base_url, null: false, default: "11.33.22"
    ...
    # unless column_exists?(:clients, :has_perplexid)
    #   add_column :clients, :has_perplexid, :boolean, default: false
    # end


    # unless Gateway.exists?(name: 'perplexid')
    #   Gateway.create(
    #     version: '1',
    #     current: true,
    #     name: 'perplexid',
