class CreateConguzConfigs < ActiveRecord::Migration[7.0]
  def change
# unless table_exists?(:conguz_configs)
    #   create_table :conguz_configs do |t|
    #     t.boolean :active, default: true
    #     t.boolean :capture, default: false
    #     t.string :base_url, null: false, default: "dd.dd..s"
    ...
    # unless column_exists?(:clients, :has_conguz)
    #   add_column :clients, :has_conguz, :boolean, default: false
    # end


    # unless Gateway.exists?(name: 'conguz')
    #   Gateway.create(
    #     version: '1',
    #     current: true,
    #     name: 'conguz',
