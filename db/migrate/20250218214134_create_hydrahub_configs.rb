class CreateHydrahubConfigs < ActiveRecord::Migration[7.0]
  def change
# unless table_exists?(:hydrahub_configs)
    #   create_table :hydrahub_configs do |t|
    #     t.boolean :active, default: true
    #     t.boolean :capture, default: false
    #     t.string :base_url, null: false, default: "api.cc.rr"
    ...
    # unless column_exists?(:clients, :has_hydrahub)
    #   add_column :clients, :has_hydrahub, :boolean, default: false
    # end


    # unless Gateway.exists?(name: 'hydrahub')
    #   Gateway.create(
    #     version: '1',
    #     current: true,
    #     name: 'hydrahub',
