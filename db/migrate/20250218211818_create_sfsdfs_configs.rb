class CreateSfsdfsConfigs < ActiveRecord::Migration[7.0]
  def change
# unless table_exists?(:sfsdfs_configs)
    #   create_table :sfsdfs_configs do |t|
    #     t.boolean :active, default: true
    #     t.boolean :capture, default: false
    #     t.string :base_url, null: false, default: "dddd"
    ...
    # unless column_exists?(:clients, :has_sfsdfs)
    #   add_column :clients, :has_sfsdfs, :boolean, default: false
    # end


    # unless Gateway.exists?(name: 'sfsdfs')
    #   Gateway.create(
    #     version: '1',
    #     current: true,
    #     name: 'sfsdfs',
