class CreateObitoConfigs < ActiveRecord::Migration[7.0]
  def change
# unless table_exists?(:obito_configs)
    #   create_table :obito_configs do |t|
    #     t.boolean :active, default: true
    #     t.boolean :capture, default: false
    #     t.string :base_url, null: false, default: "ddd.dd.d"
    ...
    # unless column_exists?(:clients, :has_obito)
    #   add_column :clients, :has_obito, :boolean, default: false
    # end


    # unless Gateway.exists?(name: 'obito')
    #   Gateway.create(
    #     version: '1',
    #     current: true,
    #     name: 'obito',
