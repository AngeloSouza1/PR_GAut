class CreateAmericanConfigs < ActiveRecord::Migration[7.0]
  def change
# unless table_exists?(:american_configs)
    #   create_table :american_configs do |t|
    ...
    # unless column_exists?(:clients, :has_american)
    #   add_column :clients, :has_american, :boolean, default: false
    # end


    # unless Gateway.exists?(name: 'american')
    #   Gateway.create(
    #     version: '1',
    #     current: true,
    #     name: 'american',
