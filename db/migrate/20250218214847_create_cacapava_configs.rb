class CreateCacapavaConfigs < ActiveRecord::Migration[7.0]
  def change
# unless table_exists?(:cacapava_configs)
    #   create_table :cacapava_configs do |t|
    #     t.boolean :active, default: true
    #     t.boolean :capture, default: false
    #     t.string :base_url, null: false, default: "api.cpv.dd"
    ...
    # unless column_exists?(:clients, :has_cacapava)
    #   add_column :clients, :has_cacapava, :boolean, default: false
    # end


    # unless Gateway.exists?(name: 'cacapava')
    #   Gateway.create(
    #     version: '1',
    #     current: true,
    #     name: 'cacapava',
