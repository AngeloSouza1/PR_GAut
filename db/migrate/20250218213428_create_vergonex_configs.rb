class CreateVergonexConfigs < ActiveRecord::Migration[7.0]
  def change
# unless table_exists?(:vergonex_configs)
    #   create_table :vergonex_configs do |t|
    #     t.boolean :active, default: true
    #     t.boolean :capture, default: false
    #     t.string :base_url, null: false, default: "api.gg.sr"
    ...
    # unless column_exists?(:clients, :has_vergonex)
    #   add_column :clients, :has_vergonex, :boolean, default: false
    # end


    # unless Gateway.exists?(name: 'vergonex')
    #   Gateway.create(
    #     version: '1',
    #     current: true,
    #     name: 'vergonex',
