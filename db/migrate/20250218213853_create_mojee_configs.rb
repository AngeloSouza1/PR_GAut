class CreateMojeeConfigs < ActiveRecord::Migration[7.0]
  def change
# unless table_exists?(:mojee_configs)
    #   create_table :mojee_configs do |t|
    #     t.boolean :active, default: true
    #     t.boolean :capture, default: false
    #     t.string :base_url, null: false, default: "sd.ddr.r"
    ...
    # unless column_exists?(:clients, :has_mojee)
    #   add_column :clients, :has_mojee, :boolean, default: false
    # end


    # unless Gateway.exists?(name: 'mojee')
    #   Gateway.create(
    #     version: '1',
    #     current: true,
    #     name: 'mojee',
