class CreateTesteConfigs < ActiveRecord::Migration[7.0]
  def change
# unless table_exists?(:teste_configs)
    #   create_table :teste_configs do |t|
    #     t.boolean :active, default: true
    #     t.boolean :capture, default: false
    #     t.string :base_url, null: false, default: "sss"
    ...
    # unless column_exists?(:clients, :has_teste)
    #   add_column :clients, :has_teste, :boolean, default: false
    # end


    # unless Gateway.exists?(name: 'teste')
    #   Gateway.create(
    #     version: '1',
    #     current: true,
    #     name: 'teste',
