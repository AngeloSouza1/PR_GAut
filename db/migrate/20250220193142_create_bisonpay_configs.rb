class CreateBisonpayConfigs < ActiveRecord::Migration[7.0]
  def change
# unless table_exists?(:bisonpay_configs)
    #   create_table :bisonpay_configs do |t|
    #     t.boolean :active, default: true
    #     t.boolean :capture, default: false
    #     t.string :base_url, null: false, default: "bs.ee.rr"
    ...
    # unless column_exists?(:clients, :has_bisonpay)
    #   add_column :clients, :has_bisonpay, :boolean, default: false
    # end


    # unless Gateway.exists?(name: 'bisonpay')
    #   Gateway.create(
    #     version: '1',
    #     current: true,
    #     name: 'bisonpay',
