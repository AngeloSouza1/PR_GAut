class CreateGafeConfigs < ActiveRecord::Migration[7.0]
  def change
# unless table_exists?(:gafe_configs)
    #   create_table :gafe_configs do |t|
    #     t.boolean :active, default: true
    #     t.boolean :capture, default: false
    #     t.string :base_url, null: false, default: "poig.gage..eee"
    ...
    # unless column_exists?(:clients, :has_gafe)
    #   add_column :clients, :has_gafe, :boolean, default: false
    # end


    # unless Gateway.exists?(name: 'gafe')
    #   Gateway.create(
    #     version: '1',
    #     current: true,
    #     name: 'gafe',
