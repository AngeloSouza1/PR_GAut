class MotorolaConfig < ApplicationRecord
## PARANOIA
   acts_as_paranoid
   ...
   def gateway_config
     gateway = Gateway.find_by_name("Motorola")
   ...
   def webhook_url
     ...
     "/api/v1/webhook/Motorola/payments"
   end
   ...
   def set_active_attribute
     ...
     self.active = true if store.Motorola_config.nil?
   end
end
