class BisonpayConfig < ApplicationRecord
## PARANOIA
   acts_as_paranoid
   ...
   def gateway_config
     gateway = Gateway.find_by_name("Bisonpay")
   ...
   def webhook_url
     ...
     "/api/v1/webhook/Bisonpay/payments"
   end
   ...
   def set_active_attribute
     ...
     self.active = true if store.Bisonpay_config.nil?
   end
end
