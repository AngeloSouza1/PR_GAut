class AmericanConfig < ApplicationRecord
## PARANOIA
   acts_as_paranoid
   ...
   def gateway_config
     gateway = Gateway.find_by_name("American")
   ...
   def webhook_url
     ...
     "/api/v1/webhook/American/payments"
   end
   ...
   def set_active_attribute
     ...
     self.active = true if store.American_config.nil?
   end
end
